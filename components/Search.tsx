    ...
    <>
      ...
      >
        <input
          ...
          value={searchText}
          className="rounded dark:bg-[#282c34] bg-[#e6e7ea] dark:text-white text-[#110B29]
        placeholder:text-gray-400 pl-2 required outline-0 border border-transparent w-full py-1 focus:border-cyan"
        ...
        >
          <FontAwesomeIcon icon={faSearch} className="text-[#AA0099]"/>
        </button>
      </form>

      {searchText.length > 0 ? (
        <ul
          className="absolute top-11 w-64 md:w-96 h-96 rounded-lg
overflow-x-hidden py-2 bg-[#282c34] bg-opacity-60 z-20
...
"
        >
          {searchData ? (
            ...
            border-b-gray-400 animate-spin
            "
                role="status"
              />
