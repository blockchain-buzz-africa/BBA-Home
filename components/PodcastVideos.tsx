...
const PodcastVideos = (props: Props) => {
  ...
  return (
    <div className="p-5 md:hidden lg:hidden flex flex-col gap-5">
      <span className="text-xl text-[#AA0099] uppercase">Podcasts: VIDEOS</span>
      {videos.map((video) => (
        <div key={video._id} className="w-full mb-20 h-[200px] mt-3 relative">
          ...
          <div className="w-full h-[48px] bg-[#AA0099] flex absolute -bottom-20">
            <div className="flex flex-col w-[70%] gap-1 text-sm p-1">
              <span className="uppercase text-white font-semibold text-xs">{video.title}</span>
