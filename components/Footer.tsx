        ...
        <div className="w-full flex text-white flex-col gap-4 h-[229px] sm:p-2 p-7 bg-gradient-to-tr from-[#AA0099] to-[#163159]">
          ...
          <div className="w-full text-xs h-[34px] relative">
            <input
              ...
              className="w-[70%] text-black h-[34px] absolute top-0 left-0 text-sm p-1"
            />
            <button className="w-[30%] h-[34px] bg-[#163159] text-xs uppercase absolute top-0 right-0 flex justify-center items-center p-2">
              subscribe
            </button>
          </div>
        </div>
